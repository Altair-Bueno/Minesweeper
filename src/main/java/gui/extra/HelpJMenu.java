...
public class HelpJMenu extends JMenu {
    ...
    public HelpJMenu() {
        super(Language
                .getResourceBundle()
                .getString("Help"));
        help = new JMenuItem(Language
                .getResourceBundle()
                .getString("How_play"));
        add(help);
        help.addActionListener(e ->
                new HtmlViewer(Loader.getResourceURL(Loader.HTMLDoc.HELP_PAGE),
                        Language.getResourceBundle().getString("Help"))
        );

        //Adds the about menu on the help
        if (!Platform.isHostOSMac()) {
            about = new JMenuItem(Language
                    .getResourceBundle()
                    .getString("About"));
