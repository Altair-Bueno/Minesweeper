...
public class ThemeManagerJMenu extends JMenu {
    ...
    public ThemeManagerJMenu() {
        ...
        light = new JMenuItem(Language
                .getResourceBundle()
                .getString("Claro")
        );
        light.setActionCommand(LIGHT);
        dracula = new JMenuItem(Language
                .getResourceBundle()
                .getString("Oscuro")
        );
        dracula.setActionCommand(DRACULA);
        purple = new JMenuItem(Language
                .getResourceBundle()
                .getString("Morado")
        );
        ...
        light.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_1,
                Platform.getMainKeyboardActionEvent()));
        dracula.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_2,
                Platform.getMainKeyboardActionEvent()));
        purple.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_3,
                Platform.getMainKeyboardActionEvent()));
